/**
 * Представление карточек: отрисовка и обновление.
 */

export class JournalCardsView {
    constructor(model) {
        this.model = model;
    }
...
">
                    ...
                    ${j.isStressType() ? `<svg class="details-btn" data-version-id="${row.VersionID}" width="24" height="24" viewBox="0 0 32 32" style="cursor: pointer;" tooltipe="Подробнее" fill="#004c97" xmlns="http://www.w3.org/2000/svg">
